...
cleartables.json: cleartables.yaml yaml2json.py
	./yaml2json.py < cleartables.yaml > cleartables.json || (rm -f cleartables.json && exit 1)

sql/post/comments.sql: cleartables.yaml createcomments.py
	mkdir -p sql/post && \
