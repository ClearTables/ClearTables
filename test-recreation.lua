...
assert(transform_recreation({leisure="dog_park"}).recreation == "dog_park", "test failed: park")
assert(transform_recreation({leisure="golf_course"}).recreation == "golf", "test failed: park")
